...
class MipsParser(yappsrt.Parser):
    ...
    def program(self, _parent=None):
        ...
        while self._peek('"\\n"', 'COMMENT', '".data\\n"', '".text\\n"', 'LABEL', 'SYSTEM_CALL', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"', 'END') in ['"\\n"', 'COMMENT']:
            empty_line = self.empty_line(_context)
        if self._peek() not in ['"\\n"', 'COMMENT', '".data\\n"', '".text\\n"', 'LABEL', 'SYSTEM_CALL', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"', 'END']:
    ...
    def data(self, _parent=None):
        ...
        self._scan('".data\\n"')
        allocations = []
        while self._peek('"\\n"', 'COMMENT', 'LABEL', 'SYSTEM_CALL', '".data\\n"', '".text\\n"', 'END', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"') in ['"\\n"', 'COMMENT', 'LABEL']:
            _token = self._peek('"\\n"', 'COMMENT', 'LABEL')
            if _token == 'LABEL':
                ...
                empty_line = self.empty_line(_context)
        if self._peek() not in ['"\\n"', 'COMMENT', 'LABEL', 'SYSTEM_CALL', '".data\\n"', '".text\\n"', 'END', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"']:
            raise yappsrt.SyntaxError(charpos=self._scanner.get_prev_char_pos(), context=_context, msg='Need one of ' + ', '.join(['"\\n"', 'COMMENT', 'LABEL', 'SYSTEM_CALL', '".data\\n"', '".text\\n"', 'END', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"']))
        return allocations
    ...
    def text(self, _parent=None):
        ...
        lines = []
        while 1:
            _token = self._peek('LABEL', 'SYSTEM_CALL', '"\\n"', 'COMMENT', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"')
            if _token not in ['LABEL', 'SYSTEM_CALL', '"\\n"', 'COMMENT']:
                ...
                empty_line = self.empty_line(_context)
            if self._peek('LABEL', 'SYSTEM_CALL', '"\\n"', 'COMMENT', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"', '".data\\n"', '".text\\n"', 'END') not in ['LABEL', 'SYSTEM_CALL', '"\\n"', 'COMMENT', '"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"']: break
        return lines
    ...
    def statement(self, _parent=None):
        ...
        _token = self._peek('"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"', '"add"', '"sub"', '"addu"', '"addi"', '"addiu"', '"subu"', '"div"', '"divu"', '"mult"', '"and"', '"or"', '"andi"', '"ori"', '"beq"', '"bne"', '"slt"', '"slti"', '"sltu"', '"sltiu"', '"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"')
        if _token in ['"j"', '"jal"', '"jr"', '"mfhi"', '"mflo"', '"lw"', '"sw"']:
            ...
            ret = math_op
        elif _token not in ['"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"']:
    ...
    def pseudo_op(self, _parent=None):
        ...
        _token = self._peek('"la"', '"li"', '"bgt"', '"blt"', '"bge"', '"ble"', '"bgtu"', '"bgtz"', '"move"')
        if _token == '"la"':
